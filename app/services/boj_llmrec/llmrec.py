...
class Session:
    def __init__(self, user_handle: str, recommendations: list[int], llm: LLM, conv_id: str, history: list = []) -> None:
...
class LLMRec:
    ...
    def get_new_session(self, user_handle: str, conv_id: str) -> Session:
        ...
        session = Session(user_handle, rec_df, self.llm, conv_id, self.prev_msgs)
        return session 
